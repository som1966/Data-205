...
The senior population (80+) is projected to grow by 2,510 people, projected housing estimate will serve approxmately 1,011 people; a potential shortfall of 1250 units. Currently there is no a potential senior housing in the pipeline. It should be noted that not everyone in this age group will desire or need senior housing (home owner, family, multi-family housing).  Therefore, it is recommended that a more detailed analyses be conducted for this particular population.
